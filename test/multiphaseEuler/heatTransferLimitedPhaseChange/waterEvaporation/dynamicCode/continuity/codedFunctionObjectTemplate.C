...
{
    // dynamicCode:
    // SHA1 = 352b58499209f8be8bacacc8301c3d21c343b3e8
    //
    // unique function name that can be checked if the correct library version
    // has been loaded
    void continuity_352b58499209f8be8bacacc8301c3d21c343b3e8(bool load)
    {
        if (load)
        {
...
bool continuityFunctionObject::read(const dictionary& dict)
{
    if (false)
    {
        Info<<"read continuity sha1: 352b58499209f8be8bacacc8301c3d21c343b3e8\n";
    }

//{{{ begin code
    #line 25 "/home/kol/OpenFOAM/OpenFOAM-13/test/multiphaseEuler/heatTransferLimitedPhaseChange/waterEvaporation/system/functions/continuity"
...
Foam::wordList continuityFunctionObject::fields() const
{
    if (false)
    {
        Info<<"fields continuity sha1: 352b58499209f8be8bacacc8301c3d21c343b3e8\n";
    }
...
bool continuityFunctionObject::execute()
{
    if (false)
    {
        Info<<"execute continuity sha1: 352b58499209f8be8bacacc8301c3d21c343b3e8\n";
    }

//{{{ begin code
    #line 78 "/home/kol/OpenFOAM/OpenFOAM-13/test/multiphaseEuler/heatTransferLimitedPhaseChange/waterEvaporation/system/functions/continuity"
...
bool continuityFunctionObject::write()
{
    if (false)
    {
        Info<<"write continuity sha1: 352b58499209f8be8bacacc8301c3d21c343b3e8\n";
    }
...
bool continuityFunctionObject::end()
{
    if (false)
    {
        Info<<"end continuity sha1: 352b58499209f8be8bacacc8301c3d21c343b3e8\n";
    }
