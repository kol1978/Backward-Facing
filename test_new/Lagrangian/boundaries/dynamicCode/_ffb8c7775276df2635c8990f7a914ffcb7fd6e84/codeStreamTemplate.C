...
extern "C"
{
    void codeStream_ffb8c7775276df2635c8990f7a914ffcb7fd6e84
    (
        Ostream& os,
    ...
    {
//{{{ begin code
        #line 159 "/home/kol/OpenFOAM/OpenFOAM-14/test/Lagrangian/boundaries/system/blockMeshDict!#codeStream"
            ...
            forAll(patchNames, yi)
            {
                for (label xi = 0; xi < 4; ++ xi)
                {
                    ...
                    {
                        os  << word("inGroups") << patchGroups[yi]
                            << token::END_STATEMENT;
                    }
