...
extern "C"
{
    void codeStream_32c024796281bc5925e3fc23f245ec746af33e16
    (
        Ostream& os,
    ...
    {
//{{{ begin code
        #line 45 "/home/kol/OpenFOAM/OpenFOAM-14/test/Lagrangian/boundaries/system/blockMeshDict!#codeStream"
            ...
            const scalar tanTheta = tan(dict.lookupScoped<scalar>("theta", true, false));
            const scalar tanPhi = tan(dict.lookupScoped<scalar>("phi", true, false));
