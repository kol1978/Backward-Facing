...
{
    // dynamicCode:
    // SHA1 = faa455ff361eca44eba2373966979be11a5d9020
    //
    // unique function name that can be checked if the correct library version
    // has been loaded
    void continuity_faa455ff361eca44eba2373966979be11a5d9020(bool load)
    {
        if (load)
        {
...
bool continuityFunctionObject::read(const dictionary& dict)
{
    if (false)
    {
        Info<<"read continuity sha1: faa455ff361eca44eba2373966979be11a5d9020\n";
    }

//{{{ begin code
    #line 25 "/home/kol/OpenFOAM/OpenFOAM-13/test/multiphaseEuler/massDiffusionLimitedPhaseChange/waterAndIsopropanolEvaporation/system/functions/continuity"
...
Foam::wordList continuityFunctionObject::fields() const
{
    if (false)
    {
        Info<<"fields continuity sha1: faa455ff361eca44eba2373966979be11a5d9020\n";
    }
...
bool continuityFunctionObject::execute()
{
    if (false)
    {
        Info<<"execute continuity sha1: faa455ff361eca44eba2373966979be11a5d9020\n";
    }

//{{{ begin code
    #line 78 "/home/kol/OpenFOAM/OpenFOAM-13/test/multiphaseEuler/massDiffusionLimitedPhaseChange/waterAndIsopropanolEvaporation/system/functions/continuity"
...
bool continuityFunctionObject::write()
{
    if (false)
    {
        Info<<"write continuity sha1: faa455ff361eca44eba2373966979be11a5d9020\n";
    }
...
bool continuityFunctionObject::end()
{
    if (false)
    {
        Info<<"end continuity sha1: faa455ff361eca44eba2373966979be11a5d9020\n";
    }
